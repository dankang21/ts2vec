...
if __name__ == '__main__':
    ...
    parser.add_argument('--window-in', type=int, default=0, help='window-in dataset num (defaults to 0 set test set as 20% of total datasets.)')
    ...
    if args.loader == 'UCR':
        ...
        task_type = 'forecasting'
        data, train_slice, valid_slice, test_slice, scaler, pred_lens, n_covariate_cols = datautils.load_forecast_csv(args.dataset, args.window_in, univar=True)
        train_data = data[:, train_slice]
